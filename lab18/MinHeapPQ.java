...
public class MinHeapPQ<T> implements PriorityQueue<T> {
    ...
    public MinHeap<PriorityItem> heap;
    ...
    public void insert(T item, double priorityValue) {
        // TODO: YOUR CODE HERE
        PriorityItem thingToInsert = new PriorityItem(item, priorityValue);
        heap.insert(thingToInsert);
    }
    ...
    public void changePriority(T item, double priorityValue) {
        // TODO: YOUR CODE HERE
        PriorityItem newPI = new PriorityItem(item, priorityValue);
        heap.update(newPI);
    }
